// ProcessInjectionBasics.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
    ...
    HANDLE notepad = OpenProcess(PROCESS_ALL_ACCESS, false, 12096);
